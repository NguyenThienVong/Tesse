    ...
    <div className='mx-auto max-w-max'>
      <div className='mt-32'>
        <div className='xl:flex lg:flex sm:float-none md:flex xr:ml-3 xl:ml-7 sm:ml-6 se:ml-3'>
          ...
          <ul className='flex'>
            <li className='xl:mx-4 xr:mx-2 se:mr-3 font-normal text-sm text-regal-Primary'><a href='#'>Tất Cả</a></li>
            <li className=' xl:mx-4 xr:mx-2 se:mr-3 font-normal text-sm text-gray-500 hover:text-regal-Primary'><a href='#'>Về Tesse</a></li>
            <li className=' xl:mx-4 xr:mx-2 se:mr-3 font-normal text-sm text-gray-500 hover:text-regal-Primary'><a href='#'>Công Nghệ</a></li>
            <li className=' xl:mx-4 xr:mx-2 se:mr-3 font-normal text-sm text-gray-500 hover:text-regal-Primary'><a href='#'>Giáo Dục</a></li>
          </ul>
          <Link to="/news">
