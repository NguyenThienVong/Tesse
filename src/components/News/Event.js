...
const Event = () => {
  return (
        <div className='xl:mt-44 lg:mt-44 md:mt-44 sm:mt-44 xr:mt-20 mx-auto max-w-max'>
        <div className='xl:flex lg:flex sm:float-none md:flex xr:ml-3 xl:ml-7 sm:ml-6 se:ml-3 pt-10'>
          <div className='font-semibold text-2xl text-regal-Character'>Sự kiện của Tesse</div>
          <div className=' xl:justify-end xl:ml-[780px] lg:ml-[300px] md:ml-0 md:mt-2 sm:-ml-3 sm:mt-5 xr:mt-4 '>
          <button className=' xl:mx-4 xr:mx-2 font-normal text-sm  gap-8 p-2 -mt-2 hover:shadow-xl rounded-full bg-white'>Xem toàn bộ</button>
          </div>
        </div>
        {/* -------------------------------------------------------- */}
        <div className=' mt-8 xr:ml-1 flex xl:overflow-hidden lg:overflow-x-scroll md:overflow-x-scroll xr:scrolling-container se:scrolling-container se:overflow-x-scroll sm:overflow-x-scroll xr:overflow-x-scroll pb-10'>
           {/* ------------------------ */}
            <div className='sm:mx-5 se:mx-4 xr:mr-0 hover:shadow-2xl hover:rounded-xl cursor-pointer'>
            <img className='w-auto h-36' src='/img/Event1.png'/>
            ...
            <img className='w-auto h-36' src='/img/Event2.png'/>
            ...
            {/* ------------------------------*/}
            <div className='sm:mr-4 se:mr-4 xr:mr-0 hover:shadow-2xl hover:rounded-xl cursor-pointer'>
            <img className='w-auto h-36' src='/img/Event3.png'/>
            ...
            <img className='w-auto h-36' src='/img/Event4.png'/>
